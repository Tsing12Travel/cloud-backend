...
public class ErpSupplierSaveReqVO {
    ...
    @Schema(description = "供应商名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "supplierName")
    ...
    @Schema(description = "开户行", example = "ICBC")
    private String bankName;

    @Schema(description = "开户账号", example = "622908212277228617")
    private String bankAccount;

    @Schema(description = "开户地址", example = "工商银行浦东支行")
